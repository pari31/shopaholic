...
<!--Pulling Awesome "src/main/webapp/WEB-INF/views/shared/navbar.jsp"Font -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<form class="form-horizontal" action="/Shopaholic/admin/supplier" method="POST">
  <fieldset>
    <div id="legend">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<form class="form-horizontal" action="/Shopaholic/admin/product" method="POST">
  <fieldset>
    <div id="legend">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<form class="form-horizontal" action="/Shopaholic/admin/category" method="POST">
  <fieldset>
    <div id="legend">
